...
MODULE COMM_DATA
    ! NX, NY, NZ : Number of space mesh points (X, Y and Z)
      INTEGER, PARAMETER :: NX = 256, NXX = NX-1, NX2 = NX/2 ! No. of X steps NX = 256
      INTEGER, PARAMETER :: NY = 256, NYY = NY-1, NY2 = NY/2 ! No. of Y steps NY = 256
      INTEGER, PARAMETER :: NZ = 32, NZZ = NZ-1, NZ2 = NZ/2 ! No. of Z steps NZ = 32
