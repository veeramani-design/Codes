...
! NX, NY, NZ : Number of space mesh points (X, Y and Z)
  INTEGER, PARAMETER :: NX = 32, NXX = NX-1, NX2 = NX/2 ! No. of X steps NX = 256
  INTEGER, PARAMETER :: NY = 32, NYY = NY-1, NY2 = NY/2 ! No. of Y steps NY = 256
  INTEGER, PARAMETER :: NZ = 4, NZZ = NZ-1, NZ2 = NZ/2 ! No. of Z steps NZ = 32
...
! INTEGER, PARAMETER :: RANDOM=0 ! No random phase in the initial function
  ...
  REAL (8), PARAMETER :: DT = 0.0005D0    !  Imaginary time propagation, Time step DT = 0.00025d0 DT = 0.016D0
