...
MODULE COMM_DATA
    ...
    MODULE GPE_DATA
      ...
      REAL (8), PARAMETER :: DX = 0.4D0, DY = 0.4D0,  DZ = 0.02D0 ! DX, DY, DZ : Space step DX = 0.05D0, DY = 0.05D0,  DZ = 0.025D0 and DT : Time step 
    ...
    ! INTEGER, PARAMETER :: RANDOM=0 ! No random phase in the initial function
      ...
      REAL (8), PARAMETER :: DT = 0.016D0    !  Imaginary time propagation, Time step DT = 0.00025d0 DT = 0.016D0
