MODULE COMM_DATA
    ! NX, NY, NZ : Number of space mesh points (X, Y and Z)  
      INTEGER, PARAMETER :: NX = 48, NXX = NX-1, NX2 = NX/2 ! NX=240
      INTEGER, PARAMETER :: NY = 40, NYY = NY-1, NY2 = NY/2 ! NY=200
      INTEGER, PARAMETER :: NZ = 32, NZZ = NZ-1, NZ2 = NZ/2 ! NZ=160
    ...
    !  
      REAL (8), PARAMETER :: DX = 0.01D0, DY = DX, DZ = DX   ! DX, DY, DZ : SPACE STEPS dx=0.005
      REAL (8), PARAMETER :: DT = 0.0004D0                   ! DT : TIME STEP  dt=0.0004
      INTEGER(8), PARAMETER  :: NATOMS = 1000.D0                   ! Number of Atoms
    ...
    !   
      ...
      REAL (8), PARAMETER :: LHY = 128*PI**0.05D0*AS**2.5D0*NATOMS**2.5D0/3  ! LHY correction term 
    !
